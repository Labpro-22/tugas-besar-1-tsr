...
void SkillCard::onDraw(Player& p, Board& b, std::vector<std::shared_ptr<Player>>& all, TileVisitor& visitor) {
...
void DemolitionSkillCard::useEffect(Player& p, Board& b, std::vector<std::shared_ptr<Player>>& all, TileVisitor& visitor) {
